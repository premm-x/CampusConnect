    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-semibold text-gray-800">ChatSpace</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex gap-6">
          {/* Sidebar */}
          <div className="w-80 bg-white rounded-lg shadow-lg h-[calc(100vh-12rem)] flex flex-col">
            {/* Search */}
          ...
          {/* Chat Area */}
          <div className="flex-1 bg-white rounded-lg shadow-lg h-[calc(100vh-12rem)] flex flex-col">
            {selectedUser ? (
              <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 bg-white p-3 rounded-full shadow-lg hover:shadow-xl transition-shadow duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
      >
